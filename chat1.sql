...
CREATE TABLE IF NOT EXISTS `user_friends` (
    ...
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_general_ci COMMENT '好友信息表';
...
CREATE TABLE IF NOT EXISTS `messages` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT '消息表';
...
CREATE TABLE IF NOT EXISTS  `groups` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT '群组表';
...
CREATE TABLE  IF NOT EXISTS `group_members` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT '群组成员表';
